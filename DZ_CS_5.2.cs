...
{
    enum ArticleType { nekachestvenni = 1, kachesnvenni = 2 }
    enum ClientType { novii = 1, postoianni = 2 }
    enum PayType { Cash = 1, CreditCard = 2 }
    ...
    struct Article
    {
        ...
        string productName;
        double productPrice;
        public Article(int productCode, string productName, double productPrice, ArticleType articleType)
        {
    ...
    struct Client
    {
        ...
        public Client(int clientCode, string clientFullName, string clientAddress, string clientPhone, ClientType clientType)
        {
        ...
        public void Show()
        {
            Console.WriteLine("clientCode:{0}\nclientFullName:{1}\nclientAddress:{2}\nclientPhone:{3}\nclientNumberOfOrders:{4}\nclientTotalAmountOfOrders:{5}\nclientType:{6}",
                clientCode, clientFullName, clientAddress, clientPhone, clientNumberOfOrders, clientTotalAmountOfOrders, clientType);
        }
    ...
    struct Request
    {
        ...
        public void Show()
        {
            ...
            foreach (RequestItem ri in listOfOrderedProducts)
                ri.Show();
            Console.WriteLine("orderAmount:{0}\nPayType:{1}", orderAmount, requestPayType);
        }
        public double order
        {
            get
    ...
    class Program
    {
        static void Main()
        {
            ...
            listOfArticle.Add(new Article(1, "ПИВО", 14000, ArticleType.nekachestvenni));
            listOfArticle.Add(new Article(1, "ВОДКА", 60000, ArticleType.nekachestvenni));
            listOfArticle.Add(new Article(1, "ВИНО", 40000, ArticleType.nekachestvenni));
            listOfArticle.Add(new Article(1, "ВИСКИ", 500000, ArticleType.nekachestvenni));
            Client client1 = new Client(1, "ВАСЯ", "Минск", "(8029)-345-34-23", ClientType.postoianni);
            Client client2 = new Client(2, "ПЕТЯ", "Минск", "(8029)-345-34-23", ClientType.novii);
            Client client3 = new Client(3, "ИРА", "Минск", "(8029)-345-34-23", ClientType.novii);
            Client client4 = new Client(1, "ВАСЯ", "Минск", "(8029)-345-34-23", ClientType.postoianni);
            ...
            listOfRequest.Add(new Request(1, client1, new DateTime(2015, 12, 31),
                          listOfRequestItem, ref listOfArticle, ref listOfClient, PayType.Cash));
